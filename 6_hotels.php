			...
			<div class="carousel slide" id="screenshot-carousel" data-ride="carousel">
				...
				<div class="carousel-inner" style="max-height: 480px">
					<div class="item active">
						<img src="images/hotels/hotel1.jpg" alt="text of the image">
					</div>
					<div class="item">
						<img src="images/hotels/hotel2.jpg" alt="text of the image">
					</div>
					<div class="item">
						<img src="images/hotels/hotel3.jpg" alt="text of the image">
					</div>
					<div class="item">
						<img src="images/hotels/hotel4.jpg" alt="text of the image">
					</div>
					<div class="item">
						<img src="images/hotels/hotel5.jpg" alt="text of the image">
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="page-header">
			<?php 
				...
				{
					echo "<h4 style='color:#14a768;'>Hotel Room Booking Completed Successfully !<h4>";
				}
				
			?>
			<h2>Hotels<small> (Best Hotels in Sri Lanka)</small></h2>
		</div>
		<form action="6_hotels.php" method="post">
		...
		<div class="row">
			...
			<?php
				...
				{
					$city = $_POST['test'];
					echo '<script type="text/javascript" src="js/hotels/'.$city.'.js"></script>';
					$query = "SELECT * FROM hotel WHERE HotelLocation='$city'";
					...
					else
					{
						...
						while($row=mysqli_fetch_assoc($results))
						{
							...
							$name = $row['HotelName'];
							$link = $row['HotelPhoto'];
							$des = $row['HotelDescription'];
							
							echo '<div class="col-lg-4" id="">
									<blockquote>
										<img src="'.$link.'" style="width:342px;height:200px;"><br>
										<div class="panel-body"><h4>'.$name.'<small style="color:red;">'.$des.'</small></h4></div>
										<a href="bookings.php?hid='.$id.'" target="_blank" style="position: absolute;">
										<button type="button" class="btn btn-danger" ">Book Now</button></a>
									</blockquote><br><br>
								</div>';
						}
					}
